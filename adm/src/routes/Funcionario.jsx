  ...
  return (
    <div className="b">
      ...
      <div className="button-grid">
        ...
        <a href="http://localhost:5173/Samuel10" className="grid-link">Listar Ocorrências por ID</a>
        <a href="http://localhost:5173/Samuel10" className="grid-link">Listar Processos por ID</a>
        <a href="http://localhost:5173/Ocosemadm" className="grid-link">Listar Ocorrências sem Admin</a>
        <a href="http://localhost:5173/Ocoadm" className="grid-link">Listar Processos do Admin</a>
      </div>      
    </div>
  );
};
